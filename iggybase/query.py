...
from iggybase.mod_admin.models import Field, TableObject
...
class SelectQuery:
    ...
    def query( self ):
        ...
        for tabletype in self.types:
            typedata = admin_db_session.query( TableObject ).filter_by( name = tabletype ).first( )
            ...
            for prop in typeprops:
                ...
                if prop.foreign_key_type_id:
                    fkdata = admin_db_session.query( TableObject ).filter_by( id = prop.foreign_key_type_id ).first( )
