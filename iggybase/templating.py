...
def page_template_context(page_form_name, **context):
    ...
    submit_action_url = page_button_action(buttons['top'])

    if submit_action_url is None:
        submit_action_url = page_button_action(buttons['bottom'])
    ...
    if 'btn_overrides' in context:
        if 'top' in context['btn_overrides']:
            buttons['top'] = btn_overrides(buttons['top'], context['btn_overrides']['top'])
        elif 'bottom' in context['btn_overrides']:
            buttons['bottom'] = btn_overrides(buttons['bottom'], context['btn_overrides']['bottom'])
